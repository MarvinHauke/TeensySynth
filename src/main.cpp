...
void loop() {
  ...
  waveform1.frequency(oscilatorCW.frequenz());
  waveform1.amplitude(oscilatorCW.volume());

  waveform2.frequency(oscilatorCW.frequenz()+oscilatorCW.detune());
  waveform2.amplitude(oscilatorCW.volume());

  waveform3.frequency(oscilatorCW.frequenz()-oscilatorCW.detune());
  waveform3.amplitude(oscilatorCW.volume());
